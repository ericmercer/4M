...
#include "../../src/wrapper/gem_config.h"
#include "mcapi_2.h"

#include <stdio.h>
#include <stdlib.h>

//CONFIGURATION - gem.c referenses this var as an extern, tells where the 4M compiled spec is.
char* specPath = "../.mcapi_2.fspec.rktd";
char* serverPath = "../../src/wrapper/gem-server.rkt";

//Error Code mapping (Modelled version just gives the string name of the constant)
typedef struct _errname {
	mcapi_status_t code;
	char* name;
} errname;
...
static errname error_map[] = {
	...
	{MCAPI_PENDING,"MCAPI_PENDING"},
	{MCAPI_TIMEOUT,"MCAPI_TIMEOUT"},
	{MCAPI_ERR_PARAMETER,"MCAPI_ERR_PARAMETER"},
	{MCAPI_ERR_DOMAIN_INVALID,"MCAPI_ERR_DOMAIN_INVALID"},
	{MCAPI_ERR_NODE_INVALID,"MCAPI_ERR_NODE_INVALID"},
	{MCAPI_ERR_NODE_INITFAILED,"MCAPI_ERR_NODE_INITFAILED"},
	{MCAPI_ERR_NODE_INITIALIZED,"MCAPI_ERR_NODE_INITIALIZED"},
	{MCAPI_ERR_NODE_NOTINIT,"MCAPI_ERR_NODE_NOTINIT"},
	{MCAPI_ERR_NODE_FINALFAILED,"MCAPI_ERR_NODE_FINALFAILED"},
	{MCAPI_ERR_PORT_INVALID,"MCAPI_ERR_PORT_INVALID"},
	{MCAPI_ERR_ENDP_INVALID,"MCAPI_ERR_ENDP_INVALID"},
	{MCAPI_ERR_ENDP_EXISTS,"MCAPI_ERR_ENDP_EXISTS"},
	{MCAPI_ERR_ENDP_GET_LIMIT,"MCAPI_ERR_ENDP_GET_LIMIT"},
	{MCAPI_ERR_ENDP_NOTOWNER,"MCAPI_ERR_ENDP_NOTOWNER"},
	{MCAPI_ERR_ENDP_REMOTE,"MCAPI_ERR_ENDP_REMOTE"},
	{MCAPI_ERR_ATTR_INCOMPATIBLE,"MCAPI_ERR_ATTR_INCOMPATIBLE"},
	{MCAPI_ERR_ATTR_SIZE,"MCAPI_ERR_ATTR_SIZE"},
	{MCAPI_ERR_ATTR_NUM,"MCAPI_ERR_ATTR_NUM"},
	{MCAPI_ERR_ATTR_VALUE,"MCAPI_ERR_ATTR_VALUE"},
	{MCAPI_ERR_ATTR_NOTSUPPORTED,"MCAPI_ERR_ATTR_NOTSUPPORTED"},
	{MCAPI_ERR_ATTR_READONLY,"MCAPI_ERR_ATTR_READONLY"},
	{MCAPI_ERR_MSG_SIZE,"MCAPI_ERR_MSG_SIZE"},
	{MCAPI_ERR_MSG_TRUNCATED,"MCAPI_ERR_MSG_TRUNCATED"},
	{MCAPI_ERR_CHAN_OPEN,"MCAPI_ERR_CHAN_OPEN"},
	{MCAPI_ERR_CHAN_TYPE,"MCAPI_ERR_CHAN_TYPE"},
	{MCAPI_ERR_CHAN_DIRECTION,"MCAPI_ERR_CHAN_DIRECTION"},
	{MCAPI_ERR_CHAN_CONNECTED,"MCAPI_ERR_CHAN_CONNECTED"},
	{MCAPI_ERR_CHAN_OPENPENDING,"MCAPI_ERR_CHAN_OPENPENDING"},
	{MCAPI_ERR_CHAN_CLOSEPENDING,"MCAPI_ERR_CHAN_CLOSEPENDING"},
	{MCAPI_ERR_CHAN_NOTOPEN,"MCAPI_ERR_CHAN_NOTOPEN"},
	{MCAPI_ERR_CHAN_INVALID,"MCAPI_ERR_CHAN_INVALID"},
	{MCAPI_ERR_PKT_SIZE,"MCAPI_ERR_PKT_SIZE"},
	{MCAPI_ERR_TRANSMISSION,"MCAPI_ERR_TRANSMISSION"},
	{MCAPI_ERR_PRIORITY,"MCAPI_ERR_PRIORITY"},
	{MCAPI_ERR_BUF_INVALID,"MCAPI_ERR_BUF_INVALID"},
	{MCAPI_ERR_MEM_LIMIT,"MCAPI_ERR_MEM_LIMIT"},
	{MCAPI_ERR_REQUEST_INVALID,"MCAPI_ERR_REQUEST_INVALID"},
	{MCAPI_ERR_REQUEST_LIMIT,"MCAPI_ERR_REQUEST_LIMIT"},
	{MCAPI_ERR_REQUEST_CANCELLED,"MCAPI_ERR_REQUEST_CANCELLED"},
	{MCAPI_ERR_WAIT_PENDING,"MCAPI_ERR_WAIT_PENDING"},
	{MCAPI_ERR_GENERAL,"MCAPI_ERR_GENERAL"},
	{MCAPI_STATUSCODE_END,"MCAPI_STATUSCODE_END"}
};
...
void mcapi_initialize(
   ...
   MCAPI_OUT mcapi_status_t* mcapi_status
	...
	gem_value info, status;
	char status_buf[64] = {0};
	char info_buf[64] = {0};
	
    GEM_DEBUG(buildMsg());

    nodeMap[threadID()] = node_id;

	maybe_out_param(&info, mcapi_info, info_buf, sizeof(info_buf));
...
mcapi_endpoint_t mcapi_endpoint_create(
   ...
   MCAPI_OUT mcapi_status_t* mcapi_status
	...
	gem_call("endpoint_create (%d %d %V %v)",
			threadID(),
			port_id,
    		status,
    		result_id);
	...
	*mcapi_status = err_name_to_code(status_buf);
    ...
    printf("NODE %u is ENDPOINT %d %d\n", nodeMap[threadID()], result_buf, port_id);
...
mcapi_endpoint_t mcapi_endpoint_get(
   ...
   MCAPI_OUT mcapi_status_t* mcapi_status
	...
	gem_call("endpoint_get (%d %d %d %d %V %v)",
			threadID(),
			domain_id,
			node_id,
			port_id,
